...
CN="Test CA"
openssl genrsa -algorithm RSA -pkeyopt rsa_keygen_bits:$KEY_BITS -out $CA_KEY
...
CN="localhost"
openssl genrsa -algorithm RSA -pkeyopt rsa_keygen_bits:$KEY_BITS -out $SERVER_KEY
...
USER_ID="testuser1"
P12_PASSWORD=
openssl genrsa -algorithm RSA -pkeyopt rsa_keygen_bits:$KEY_BITS -out $CLIENT_KEY
